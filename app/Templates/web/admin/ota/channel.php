    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <div class="box box-primary">
          <form action="<?=WEB_URL_ROOT?>/admin/ota/channel/add" method="post">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?=WEB_URL_ROOT?>/admin/ota/channel/modify/<?=$channel['ota_channel_id']?>" class="btn btn-primary">修改</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
