...
class RC4Exception extends \Exception
{

}

class KeyErrorRC4Exception extends RC4Exception
{
...
class RC4
{
  private static function rc4($keyStr, $dataStr)
  {
  ...
  private static function keyCheck($key){
      if (empty($key)) {
        throw new KeyErrorRC4Exception;
      }
  }
